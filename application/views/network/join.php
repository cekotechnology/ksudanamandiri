...
if(empty($sponsor) OR empty($upline) OR empty($posisi)){
	redirect(base_url().'network/genealogy');
} else {
?>

<div class="bd-example">
<form method="post" action="<?php echo base_url(); ?>index.php/network/join">
    ...
    <hr />
  <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
    <label>Username (alpha numeric no spasi)</label>
      <input name="username" id="username" class="form-control" value="<?= $username; ?>" type="text" required minlength="7" maxlength="15" />
    </div>
  ...
  <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
    <label>Serial/Pin</label>
      <input name="serial" id="serial" class="form-control" value="<?= $serial; ?>" type="text" maxlength="15" />
    </div>
  ...
  <hr />
   <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
    <label>Choose Package <?= $jenis_paket;?></label>
	  ...
	  ?>
      <option value="<?= $j; ?>" <?= $sele; ?>>Paket <?= $pkt[$i]; ?> (Rp <?= number_format($by[$i],0); ?>)</option>
      <?php
	 	}
	  ?> 
      </select>
  ...
  <div class="form-group">
   ...
   <div class="form-group form-group-icon-left"><i class="fa fa-phone input-icon"></i>
    <label>No Hp</label>
      <input name="hp" id="hp" type="number" class="form-control" value="<?= $hp; ?>" required  />
    </div> 
