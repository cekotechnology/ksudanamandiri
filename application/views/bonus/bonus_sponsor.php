...
<table class="table table-bordered table-striped table-booking-history">
						...
						{
						    $lev = explode("komsponsor",$db['jenis']);
						    if($db['status'] == "upgrade"){
						        $ket = 'Bonus tabungan level-'.$lev[1].' dari upgrade paket member ID: '.$db['dari'];
						        
						    } else {
						        $ket = 'Bonus tabungan level-'.$lev[1].' dari aktivasi anggota ID: '.$db['dari'];
