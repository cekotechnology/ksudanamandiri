...
<table class="table table-bordered table-striped table-booking-history">
                                                              ...
                                                              <tr>
                                                                <td align="right">Amount transfered  :</td>
                                                                <td><input name="jumlah" type="number" class="form-controle" id="jumlah" size="15" style="width:150px;" /></td>
                                                              </tr>
                                                              <tr>
                                                                <td align="right"> Transfer to :</td>
                                                                <td><input name="username" class="form-controle"  type="text" id="username" size="15" style="width:150px;" placeholder="username.."/></td>
                                                              </tr>
                                                              <tr>
                                                              ...
                                                              <tr>
                                                                <td colspan="2"><span><strong>Terms and conditions :</strong></span>
                                                                  <ol style="margin:20px;">
                                                                    <li>Minimum transfer amount US.10.00</li>
