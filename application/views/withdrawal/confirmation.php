...
<div class="btn-group btn-group-justified">
  <a href="#" class="btn btn-default">Withdraw E-Walet</a>
  <a href="#" class="btn btn-default">History E-Walet</a>
  <!--<a href="#" class="btn btn-default">Withdraw E-Register</a>
  <a href="#" class="btn btn-default">History E-Register</a>-->
</div> 


<div class="bd-example">
<h4>Konfirmasi Withdrawal E-Walet</h4>
<form method="post" action="<?php echo base_url(); ?>withdrawal/process_withdrawal_ebonus">
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label">Saldo E-Walet</label>
    <div class="col-sm-9">
      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?php echo number_format($this->ewalet_model->myewaletdone($user_session, ""),0); ?>">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="inputPassword" class="col-sm-3 col-form-label">Sisa Saldo E-Walet Setelah Penarikan</label>
    <div class="col-sm-9">
      <input name="sisa" type="number" required class="form-control" placeholder="Sisa saldo" value="<?= $this->ewalet_model->myewaletdone($user_session, "")-$jumlah; ?>" readonly>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <select class="form-control" name="tujuan">
	  ...
	  if($tujuan == "Cash"){
	  ?>
      <option value="Cash" selected>Rek. Bank</option>
     
      <?php
	  } else if($tujuan == "Deposit"){
	  ?>
     
      <option value="Deposit" selected>Rek. Bank</option>
      <?php
	  } else {
	  ?>
