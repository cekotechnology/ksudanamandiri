...
<div class="btn-group btn-group-justified">
  <a href="<?php echo base_url(); ?>withdrawal" class="btn btn-default">Withdraw E-Walet</a>
  <a href="<?php echo base_url(); ?>history" class="btn btn-default">History Transfer</a>
  <!--<a href="<?php echo base_url(); ?>withdrawal/eregister" class="btn btn-default">Withdraw E-Register</a>
  <a href="<?php echo base_url(); ?>history/eregister" class="btn btn-default">History E-Register</a>-->
</div> 


<br />
<div class="bd-example">
<h4>Form Withdrawal E-Walet</h4>
<?php
...
?>
<form method="post" action="<?php echo base_url(); ?>withdrawal/confirm">
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label">Saldo E-Walet</label>
    <div class="col-sm-9">
      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?php echo number_format($this->ewalet_model->myewaletdone($user_session, ""),2); ?>">
  ...
  <div class="form-group row">
    ...
    <select class="form-control" name="tujuan">
      ...
      <option value="Cash" selected>Rek. Bank</option>
          ...
          ?>
      <option value="Deposit">Rek. Bank</option>
          <?php
    	  }
          ?>
      <?php
...
&bull; Minimal Withdrawal Request <?php echo number_format(100000,0); ?></pre>
</div>
