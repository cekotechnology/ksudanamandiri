...
<div class="btn-group btn-group-justified">
  <a href="#" class="btn btn-default">Withdraw E-Bonus</a>
  <a href="#" class="btn btn-default">History E-Bonus</a>
...
<h4>Konfirmasi Withdrawal E-Walet Bonus</h4>
<form method="post" action="<?php echo base_url(); ?>withdrawal/process_withdrawal_ebonus">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?php echo number_format($jumlah*10000); ?>">
      
      <input type="hidden" readonly class="form-control-plaintext" name="jumlah_rp" value="<?php echo $jumlah*10000; ?>">
    </div>
  </div>
  <div class="form-group row">
