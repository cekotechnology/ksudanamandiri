...
$total_kr = 0;
$total_db = 0;
$saldo_last = $this->ewalet_model->myeregisterdone($user_session, " AND tgl<'$dtfrom'");
?>
<table class="table table-bordered table-striped table-booking-history">
                        ...
                        <tbody>
                        <tr>
                              <td colspan="3" class="booking-history-type" style="text-align:right">Previous balance</td>
                              <td align="right">&nbsp;</td>
                              <td align="right">&nbsp;</td>
                              <td align="right"><?= number_format($saldo_last,0); ?></td>
                            </tr>
                        <?php
					if($lst_eregister->num_rows()>0){
						$nom=1;
						foreach($lst_eregister->result_array() as $db)
						{
							if($db['jenis'] == "kredit"){
