...
<table  class="table table-bordered table-striped table-booking-history">
    ...
    <tr height="30">
      <td rowspan="2" align="center" style="text-align:center; vertical-align:central"><strong>REWARD</strong></td>
      <td rowspan="2" style="text-align:center; vertical-align:central"><strong>DESCRIPTION</strong></td>
      <td align="center"><strong> (Qualified)</strong></td>
      <td width="90" rowspan="2" align="center"><strong>STATUS</strong></td>
    </tr>
    <tr height="30"> 
      
      
      <td width="65" style="text-align:center"><strong> POINT ANDA</strong></td>
    </tr>
    <?php
...
//$mka = $this->network_model->hitung_omzet_reward($user_session,"KANAN","");
	...
	?>
    <tr>
      <td width="50" height="25" valign="top" style=" padding:5px; text-align:center"><img src="<?= base_url(); ?>asset/reward/<?= ${"nama_file_reward".$j}; ?>" style="width:150px;" /></td>
      <td width="200" valign="top" style=" padding:5px;">
        <?= ${"nama_reward".$j}; ?> senilai Rp <?= number_format(${"nilai_reward".$j}); ?>
        <br />
	  <br />
	 Syarat Qualified (POINT) : <br /><?= number_format(${"syarat".$j},0); ?></td>
